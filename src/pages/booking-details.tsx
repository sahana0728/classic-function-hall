          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="bg-green-50 dark:bg-green-950/30 rounded-xl p-3 border border-green-200/50 group relative">
              <div className="flex justify-between items-center mb-1">
                <p className="text-xs font-semibold text-green-700 dark:text-green-300 uppercase tracking-wider">Total Paid</p>
              </div>
              ...
              {canAddPayment ? (
                !isEditingAdvance ? (
                  <Button 
                     ...
                     variant="outline" 
                     size="sm" 
                     className="w-full bg-background/50 border-green-200 dark:border-green-800 text-green-700 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-950/60 hover:text-green-800 dark:hover:text-green-200 h-8"
                  >
                    <Plus className="w-3.5 h-3.5 mr-1" /> Add Payment
                  </Button>
                ) : (
                  <div className="flex flex-col gap-2 mt-2 bg-background rounded-md p-2 border border-green-200 dark:border-green-800 shadow-sm transition-all focus-within:ring-1 focus-within:ring-green-500">
                    <div className="relative">
                      <span className="absolute left-2.5 top-1.5 text-sm text-green-700 dark:text-green-300 font-bold z-10 pointer-events-none">₹</span>
                      <Input 
                        autoFocus
                        type="number" 
                        min="1"
                ...
                <div className="w-full bg-green-100/50 dark:bg-green-950/50 border border-green-200 dark:border-green-800 text-green-800 dark:text-green-200 text-xs font-bold text-center py-1.5 rounded uppercase tracking-wider flex items-center justify-center gap-1.5">
                  <CheckCircle2 className="w-3.5 h-3.5" /> Fully Paid
                </div>
              )}
            </div>
            <div className={`rounded-xl p-3 border ${balanceLeft === 0
              ? 'bg-green-50 dark:bg-green-950/30 border-green-200/50 dark:border-green-800'
              : 'bg-yellow-50 dark:bg-yellow-950/30 border-yellow-200/50 dark:border-yellow-800'}`}>
              <p className={`text-xs font-semibold ${balanceLeft === 0 ? 'text-green-700 dark:text-green-300' : 'text-yellow-700 dark:text-yellow-300'} uppercase tracking-wider mb-1`}>Balance</p>
